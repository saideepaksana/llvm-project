...
; GFX8-NEXT:    v_add_f32_e32 v4, v4, v6
...
; GFX8-NEXT:    v_cvt_u32_f32_e32 v11, v3
; GFX8-NEXT:    v_subrev_u32_e32 v12, vcc, s12, v1
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s8, v10, 0
; GFX8-NEXT:    v_subbrev_u32_e64 v13, s[0:1], 0, v6, vcc
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s8, v11, v[3:4]
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s13, v13
; GFX8-NEXT:    s_subb_u32 s9, 0, s15
; GFX8-NEXT:    v_cndmask_b32_e64 v14, 0, -1, s[0:1]
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s9, v10, v[3:4]
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s12, v12
; GFX8-NEXT:    v_cndmask_b32_e64 v4, 0, -1, s[0:1]
; GFX8-NEXT:    v_mul_lo_u32 v15, v11, v2
; GFX8-NEXT:    v_mul_lo_u32 v16, v10, v3
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[0:1], s13, v13
; GFX8-NEXT:    v_cndmask_b32_e64 v14, v14, v4, s[0:1]
; GFX8-NEXT:    v_mul_hi_u32 v4, v10, v2
; GFX8-NEXT:    v_add_u32_e64 v15, s[0:1], v15, v16
; GFX8-NEXT:    v_cndmask_b32_e64 v16, 0, 1, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v4, s[0:1], v15, v4
; GFX8-NEXT:    v_subb_u32_e32 v4, vcc, v6, v5, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s[0:1]
; GFX8-NEXT:    v_mul_hi_u32 v2, v11, v2
; GFX8-NEXT:    v_mul_lo_u32 v6, v11, v3
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v16, v5
; GFX8-NEXT:    v_mul_hi_u32 v16, v10, v3
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v6, v2
; GFX8-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v2, v16
; GFX8-NEXT:    v_cndmask_b32_e64 v16, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e64 v15, s[2:3], 1, v7
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v6, v16
; GFX8-NEXT:    v_addc_u32_e64 v17, s[2:3], 0, v8, s[2:3]
; GFX8-NEXT:    v_add_u32_e32 v16, vcc, 1, v15
; GFX8-NEXT:    v_addc_u32_e32 v18, vcc, 0, v17, vcc
; GFX8-NEXT:    v_subrev_u32_e32 v19, vcc, s12, v12
...
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s8, v10, 0
; GFX8-NEXT:    v_addc_u32_e32 v11, vcc, v11, v3, vcc
; GFX8-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s8, v11, v[5:6]
; GFX8-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v14
; GFX8-NEXT:    v_cndmask_b32_e32 v2, v15, v16, vcc
; GFX8-NEXT:    v_mad_u64_u32 v[5:6], s[2:3], s9, v10, v[5:6]
; GFX8-NEXT:    v_cndmask_b32_e32 v3, v17, v18, vcc
; GFX8-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v9
; GFX8-NEXT:    v_cndmask_b32_e64 v2, v7, v2, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v3, v8, v3, s[0:1]
; GFX8-NEXT:    v_mul_lo_u32 v7, v11, v4
; GFX8-NEXT:    v_mul_lo_u32 v8, v10, v5
; GFX8-NEXT:    v_mul_hi_u32 v9, v10, v4
; GFX8-NEXT:    v_cndmask_b32_e32 v6, v12, v19, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v12, v13, v20, vcc
...
; GFX8-NEXT:    v_mul_hi_u32 v4, v11, v4
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, v8, v7
; GFX8-NEXT:    v_mul_hi_u32 v8, v10, v5
...
; GFX8-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, v7, v8
; GFX8-NEXT:    v_add_u32_e32 v10, vcc, v4, v1
; GFX8-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, v7, v1
; GFX8-NEXT:    v_mul_hi_u32 v7, s11, v5
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[2:3], s14, v10, 0
; GFX8-NEXT:    v_add_u32_e32 v11, vcc, v7, v1
; GFX8-NEXT:    v_mad_u64_u32 v[8:9], s[2:3], s14, v11, v[5:6]
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v0, v12, s[0:1]
; GFX8-NEXT:    v_mov_b32_e32 v5, s15
; GFX8-NEXT:    v_mad_u64_u32 v[0:1], s[0:1], s15, v10, v[8:9]
...
; GFX8-NEXT:    v_cndmask_b32_e64 v4, v10, v5, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v5, v11, v14, s[0:1]
...
; GFX9-NEXT:    v_cndmask_b32_e64 v9, v3, v9, s[0:1]
...
; GFX9-NEXT:    v_subrev_co_u32_e32 v12, vcc, s4, v1
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s8, v10, 0
; GFX9-NEXT:    v_subbrev_co_u32_e64 v13, s[0:1], 0, v6, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s8, v11, v[3:4]
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s5, v13
; GFX9-NEXT:    v_cndmask_b32_e64 v14, 0, -1, s[0:1]
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s9, v10, v[3:4]
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s4, v12
; GFX9-NEXT:    v_cndmask_b32_e64 v4, 0, -1, s[0:1]
; GFX9-NEXT:    v_mul_lo_u32 v15, v11, v2
; GFX9-NEXT:    v_mul_lo_u32 v16, v10, v3
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[0:1], s5, v13
; GFX9-NEXT:    v_cndmask_b32_e64 v14, v14, v4, s[0:1]
; GFX9-NEXT:    v_mul_hi_u32 v4, v10, v2
; GFX9-NEXT:    v_add_co_u32_e64 v15, s[0:1], v15, v16
; GFX9-NEXT:    v_cndmask_b32_e64 v16, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v4, s[0:1], v15, v4
; GFX9-NEXT:    v_subb_co_u32_e32 v4, vcc, v6, v5, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, 1, s[0:1]
; GFX9-NEXT:    v_mul_hi_u32 v2, v11, v2
; GFX9-NEXT:    v_mul_lo_u32 v6, v11, v3
; GFX9-NEXT:    v_add_u32_e32 v5, v16, v5
; GFX9-NEXT:    v_mul_hi_u32 v16, v10, v3
; GFX9-NEXT:    v_add_co_u32_e64 v15, s[2:3], 1, v7
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v6, v2
; GFX9-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v2, v16
; GFX9-NEXT:    v_cndmask_b32_e64 v16, 0, 1, vcc
; GFX9-NEXT:    v_addc_co_u32_e64 v17, s[2:3], 0, v8, s[2:3]
; GFX9-NEXT:    v_add_u32_e32 v6, v6, v16
; GFX9-NEXT:    v_add_co_u32_e32 v16, vcc, 1, v15
; GFX9-NEXT:    v_addc_co_u32_e32 v18, vcc, 0, v17, vcc
; GFX9-NEXT:    v_mul_hi_u32 v3, v11, v3
; GFX9-NEXT:    v_subrev_co_u32_e32 v19, vcc, s4, v12
; GFX9-NEXT:    v_subbrev_co_u32_e32 v20, vcc, 0, v4, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, v2, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v10, vcc, v10, v2
; GFX9-NEXT:    v_add3_u32 v3, v6, v4, v3
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s8, v10, 0
; GFX9-NEXT:    v_addc_co_u32_e32 v11, vcc, v11, v3, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s8, v11, v[5:6]
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v14
; GFX9-NEXT:    v_cndmask_b32_e32 v2, v15, v16, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[5:6], s[2:3], s9, v10, v[5:6]
; GFX9-NEXT:    v_cndmask_b32_e32 v3, v17, v18, vcc
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v7, v2, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v3, v8, v3, s[0:1]
; GFX9-NEXT:    v_mul_lo_u32 v7, v11, v4
; GFX9-NEXT:    v_mul_lo_u32 v8, v10, v5
; GFX9-NEXT:    v_mul_hi_u32 v9, v10, v4
; GFX9-NEXT:    v_cndmask_b32_e32 v6, v12, v19, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v12, v13, v20, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v7, vcc, v7, v8
; GFX9-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v7, vcc, v7, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GFX9-NEXT:    v_mul_lo_u32 v9, v11, v5
; GFX9-NEXT:    v_mul_hi_u32 v4, v11, v4
; GFX9-NEXT:    v_add_u32_e32 v7, v8, v7
; GFX9-NEXT:    v_mul_hi_u32 v8, v10, v5
...
; GFX9-NEXT:    v_addc_co_u32_e32 v5, vcc, v11, v5, vcc
...
; GFX9-NEXT:    v_mul_hi_u32 v9, s19, v5
; GFX9-NEXT:    v_add_co_u32_e32 v4, vcc, v7, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v4, vcc, v4, v8
; GFX9-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v10, vcc, v4, v1
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[2:3], s6, v10, 0
; GFX9-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GFX9-NEXT:    v_add_u32_e32 v7, v7, v8
; GFX9-NEXT:    v_add3_u32 v11, v7, v1, v9
; GFX9-NEXT:    v_mad_u64_u32 v[8:9], s[2:3], s6, v11, v[5:6]
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v0, v12, s[0:1]
; GFX9-NEXT:    v_mov_b32_e32 v5, s7
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[0:1], s7, v10, v[8:9]
...
; GFX9-NEXT:    v_cndmask_b32_e64 v4, v10, v5, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v5, v11, v14, s[0:1]

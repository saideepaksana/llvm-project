...
; CHECK-NEXT:    v_mul_hi_u32 v7, v9, v7
...
; CHECK-NEXT:    v_addc_u32_e32 v9, vcc, v9, v7, vcc
; CHECK-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v10, v3, 0
; CHECK-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v10, v9, v[7:8]
; CHECK-NEXT:    v_ashrrev_i32_e32 v10, 31, v5
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v4, v10
; CHECK-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v11, v3, v[7:8]
; CHECK-NEXT:    v_addc_u32_e32 v5, vcc, v5, v10, vcc
; CHECK-NEXT:    v_xor_b32_e32 v8, v4, v10
; CHECK-NEXT:    v_mul_lo_u32 v4, v9, v6
; CHECK-NEXT:    v_mul_lo_u32 v11, v3, v7
; CHECK-NEXT:    v_xor_b32_e32 v12, v5, v10
...
; CHECK-NEXT:    v_addc_u32_e32 v4, vcc, v9, v5, vcc
...
; CHECK-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CHECK-NEXT:    v_mul_lo_u32 v7, v12, v4
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, v6, v5
...
; CHECK-NEXT:    v_mul_hi_u32 v6, v12, v4
; CHECK-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v2, v7, 0
; CHECK-NEXT:    v_add_i32_e32 v6, vcc, v6, v5
...
; CHECK-NEXT:    v_cvt_u32_f32_e32 v4, v1
...
; GISEL-NEXT:    v_subb_u32_e32 v16, vcc, 0, v9, vcc
...
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v15, v13, 0
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v15, v14, v[5:6]
; GISEL-NEXT:    v_mul_lo_u32 v5, v14, v4
; GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v16, v13, v[11:12]
; GISEL-NEXT:    v_mul_lo_u32 v12, v13, v11
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, v5, v12
; GISEL-NEXT:    v_mul_hi_u32 v12, v13, v4
...
; GISEL-NEXT:    v_xor_b32_e32 v15, v0, v5
; GISEL-NEXT:    v_mul_lo_u32 v0, v14, v4
; GISEL-NEXT:    v_mul_lo_u32 v12, v13, v11
; GISEL-NEXT:    v_xor_b32_e32 v16, v1, v5
; GISEL-NEXT:    v_mul_hi_u32 v1, v13, v4
; GISEL-NEXT:    v_mul_hi_u32 v4, v14, v4
...
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, 1, v13
...
; GISEL-NEXT:    v_addc_u32_e32 v10, vcc, 0, v15, vcc
...
; GISEL-NEXT:    v_sub_i32_e64 v17, s[4:5], 0, v7
; GISEL-NEXT:    v_cvt_u32_f32_e32 v16, v1
; GISEL-NEXT:    v_subb_u32_e64 v18, s[4:5], 0, v6, s[4:5]
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v17, v12, 0
; GISEL-NEXT:    v_cndmask_b32_e32 v10, v15, v10, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v11
; GISEL-NEXT:    v_mul_lo_u32 v19, v16, v0
; GISEL-NEXT:    v_mul_hi_u32 v20, v12, v0
; GISEL-NEXT:    v_mul_hi_u32 v21, v16, v0
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v17, v16, v[1:2]
; GISEL-NEXT:    v_cndmask_b32_e32 v11, v13, v9, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v10, v14, v10, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v18, v12, v[0:1]
; GISEL-NEXT:    v_xor_b32_e32 v10, v10, v5
; GISEL-NEXT:    v_mul_lo_u32 v1, v12, v0
; GISEL-NEXT:    v_mul_lo_u32 v13, v16, v0
; GISEL-NEXT:    v_add_i32_e64 v1, s[4:5], v19, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s[4:5]
; GISEL-NEXT:    v_add_i32_e64 v1, s[4:5], v1, v20
...
; GISEL-NEXT:    v_add_i32_e64 v12, s[4:5], v12, v1
; GISEL-NEXT:    v_addc_u32_e64 v13, s[4:5], v16, v0, s[4:5]
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v17, v12, 0
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v17, v13, v[1:2]
; GISEL-NEXT:    v_xor_b32_e32 v1, v11, v5
; GISEL-NEXT:    v_ashrrev_i32_e32 v11, 31, v3
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v18, v12, v[8:9]
...
; GISEL-NEXT:    v_mul_lo_u32 v9, v12, v8
; GISEL-NEXT:    v_xor_b32_e32 v15, v3, v11
...
; GISEL-NEXT:    v_mul_lo_u32 v3, v13, v8
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v9, v2
; GISEL-NEXT:    v_mul_hi_u32 v9, v12, v8
...
; GISEL-NEXT:    v_mul_lo_u32 v8, v14, v2
...
; GISEL-NEXT:    v_mul_hi_u32 v8, v14, v2
...
; GISEL-NEXT:    v_mul_hi_u32 v8, v15, v2
...
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v6, v12, v[8:9]
; GISEL-NEXT:    v_subb_u32_e32 v1, vcc, v10, v5, vcc
; GISEL-NEXT:    v_sub_i32_e32 v2, vcc, v14, v2
; GISEL-NEXT:    v_subb_u32_e64 v3, s[4:5], v15, v8, vcc
; GISEL-NEXT:    v_sub_i32_e64 v5, s[4:5], v15, v8
...
; GISEL-NEXT:    v_xor_b32_e32 v4, v11, v4
...
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v13, v3
; CGP-NEXT:    v_addc_u32_e32 v12, vcc, v12, v4, vcc
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v14, v13, 0
; CGP-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v14, v12, v[4:5]
; CGP-NEXT:    v_ashrrev_i32_e32 v14, 31, v11
; CGP-NEXT:    v_mul_hi_u32 v16, v13, v3
; CGP-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v15, v13, v[4:5]
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v10, v14
; CGP-NEXT:    v_addc_u32_e32 v10, vcc, v11, v14, vcc
; CGP-NEXT:    v_xor_b32_e32 v11, v5, v14
; CGP-NEXT:    v_mul_lo_u32 v5, v12, v3
; CGP-NEXT:    v_mul_lo_u32 v15, v13, v4
; CGP-NEXT:    v_mul_hi_u32 v3, v12, v3
; CGP-NEXT:    v_xor_b32_e32 v10, v10, v14
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v5, v15
; CGP-NEXT:    v_cndmask_b32_e64 v15, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v5, v16
; CGP-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v16, v12, v4
...
; CGP-NEXT:    v_add_i32_e32 v10, vcc, 1, v13
...
; CGP-NEXT:    v_xor_b32_e32 v3, v14, v0
...
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v11, v5
; CGP-NEXT:    v_addc_u32_e32 v10, vcc, v10, v6, vcc
; CGP-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v12, v11, 0
; CGP-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v12, v10, v[6:7]
; CGP-NEXT:    v_ashrrev_i32_e32 v12, 31, v9
; CGP-NEXT:    v_mul_hi_u32 v14, v11, v5
; CGP-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v13, v11, v[6:7]
; CGP-NEXT:    v_add_i32_e32 v7, vcc, v8, v12
; CGP-NEXT:    v_addc_u32_e32 v8, vcc, v9, v12, vcc
; CGP-NEXT:    v_xor_b32_e32 v9, v7, v12
; CGP-NEXT:    v_mul_lo_u32 v7, v10, v5
; CGP-NEXT:    v_mul_lo_u32 v13, v11, v6
; CGP-NEXT:    v_mul_hi_u32 v5, v10, v5
...
; CGP-NEXT:    v_mul_hi_u32 v13, v11, v6
...
; CGP-NEXT:    v_addc_u32_e32 v6, vcc, v10, v6, vcc
...
; CGP-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v11, v8, v6
...
; CGP-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v7, vcc, v10, v5
; CGP-NEXT:    v_mul_hi_u32 v10, v8, v6
; CGP-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v4, v11, 0
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v10, v7
...
; CHECK-NEXT:    v_cvt_u32_f32_e32 v7, v3
...
; CHECK-NEXT:    v_add_i32_e32 v3, vcc, v3, v2
...
; GISEL-NEXT:    v_addc_u32_e32 v15, vcc, v8, v9, vcc
; GISEL-NEXT:    v_mul_lo_u32 v9, v15, v13
; GISEL-NEXT:    v_mul_hi_u32 v16, v4, v13
; GISEL-NEXT:    v_mul_hi_u32 v17, v15, v13
; GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v6, v15, v[14:15]
; GISEL-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], s6, v4, v[13:14]
; GISEL-NEXT:    s_mov_b32 s6, 1
; GISEL-NEXT:    s_cmp_lg_u32 s6, 0
...
; GISEL-NEXT:    v_cndmask_b32_e64 v17, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v16, vcc, v9, v16
; GISEL-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
...
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v16, v14
; GISEL-NEXT:    v_xor_b32_e32 v19, v1, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v17, v1
...
; GISEL-NEXT:    v_add_i32_e32 v16, vcc, v1, v0
...
; GISEL-NEXT:    v_xor_b32_e32 v1, v10, v9
...
; GISEL-NEXT:    v_mul_hi_u32 v0, v13, v0
; GISEL-NEXT:    v_xor_b32_e32 v7, v11, v9
...
; GISEL-NEXT:    v_mul_hi_u32 v5, v13, v2
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v4, v8, 0
...
; GISEL-NEXT:    v_add_i32_e32 v6, vcc, 1, v8
...
; CGP-NEXT:    v_addc_u32_e32 v14, vcc, v8, v12, vcc
; CGP-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v6, v4, 0
; CGP-NEXT:    v_mul_lo_u32 v15, v14, v12
; CGP-NEXT:    v_mul_hi_u32 v16, v4, v12
; CGP-NEXT:    v_mul_hi_u32 v17, v14, v12
; CGP-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v6, v14, v[13:14]
; CGP-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], -1, v4, v[12:13]
...
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v15, v13
...
; CGP-NEXT:    v_cndmask_b32_e32 v18, -1, v0, vcc
...
; CGP-NEXT:    v_addc_u32_e32 v19, vcc, 0, v17, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v18
; CGP-NEXT:    v_cndmask_b32_e32 v1, v13, v5, vcc
; CGP-NEXT:    v_mul_lo_u32 v13, v7, v0
; CGP-NEXT:    v_cndmask_b32_e32 v5, v17, v19, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v14
; CGP-NEXT:    v_cndmask_b32_e32 v14, v15, v1, vcc
; CGP-NEXT:    v_add_i32_e64 v1, s[4:5], v9, v13
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s[4:5]
; CGP-NEXT:    v_add_i32_e64 v1, s[4:5], v1, v10
...
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, 1, s[4:5]
; CGP-NEXT:    v_add_i32_e64 v9, s[4:5], v10, v9
; CGP-NEXT:    v_add_i32_e64 v0, s[4:5], v0, v9
; CGP-NEXT:    v_add_i32_e64 v7, s[4:5], v7, v1
; CGP-NEXT:    v_addc_u32_e64 v8, s[4:5], v8, v0, s[4:5]
; CGP-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v6, v7, 0
; CGP-NEXT:    v_cndmask_b32_e32 v9, v16, v5, vcc
; CGP-NEXT:    v_xor_b32_e32 v10, v14, v12
; CGP-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v6, v8, v[1:2]
; CGP-NEXT:    v_xor_b32_e32 v1, v9, v12
...
; CGP-NEXT:    v_mul_lo_u32 v6, v11, v2
; CGP-NEXT:    v_mul_hi_u32 v7, v11, v3
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v10, v12
...
; CGP-NEXT:    v_mul_hi_u32 v6, v11, v2
...
; CGP-NEXT:    v_mul_hi_u32 v6, v13, v2
; CGP-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v4, v7, 0
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v6, v5
...
; CGP-NEXT:    v_addc_u32_e32 v10, vcc, 0, v8, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v2, v4
; CGP-NEXT:    v_cndmask_b32_e64 v2, 0, -1, vcc
...
; CHECK-NEXT:    v_addc_u32_e32 v8, vcc, v8, v6, vcc
; CHECK-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v10, v9, 0
; CHECK-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v10, v8, v[6:7]
; CHECK-NEXT:    v_ashrrev_i32_e32 v10, 31, v4
; CHECK-NEXT:    v_add_i32_e32 v3, vcc, v3, v10
; CHECK-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v11, v9, v[6:7]
; CHECK-NEXT:    v_addc_u32_e32 v4, vcc, v4, v10, vcc
; CHECK-NEXT:    v_xor_b32_e32 v7, v3, v10
; CHECK-NEXT:    v_mul_lo_u32 v3, v8, v5
; CHECK-NEXT:    v_mul_lo_u32 v11, v9, v6
; CHECK-NEXT:    v_xor_b32_e32 v12, v4, v10
...
; CHECK-NEXT:    v_mul_hi_u32 v11, v9, v6
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v4, v5
; CHECK-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v4, v11
; CHECK-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
...
; CHECK-NEXT:    v_addc_u32_e32 v4, vcc, v8, v4, vcc
; CHECK-NEXT:    v_mul_lo_u32 v5, v12, v3
...
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], v5, v1
; CHECK-NEXT:    v_subbrev_u32_e32 v4, vcc, 0, v4, vcc
; CHECK-NEXT:    v_cndmask_b32_e64 v5, v7, v9, s[4:5]
...
; GISEL-NEXT:    v_sub_i32_e32 v14, vcc, 0, v8
; GISEL-NEXT:    v_subb_u32_e32 v16, vcc, 0, v7, vcc
...
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v14, v5, 0
; GISEL-NEXT:    v_mul_lo_u32 v15, v11, v9
; GISEL-NEXT:    v_mul_hi_u32 v17, v5, v9
; GISEL-NEXT:    v_mul_hi_u32 v18, v11, v9
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v14, v11, v[10:11]
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v16, v5, v[9:10]
...
; GISEL-NEXT:    v_addc_u32_e32 v17, vcc, v11, v9, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v5, 0
; GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v14, v17, v[11:12]
; GISEL-NEXT:    v_mul_lo_u32 v9, v17, v10
; GISEL-NEXT:    v_lshl_b64 v[12:13], v[12:13], v6
; GISEL-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v16, v5, v[14:15]
; GISEL-NEXT:    v_mul_hi_u32 v15, v5, v10
; GISEL-NEXT:    v_mul_lo_u32 v11, v5, v14
...
; GISEL-NEXT:    v_mul_lo_u32 v10, v17, v14
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v11, v0
; GISEL-NEXT:    v_mul_hi_u32 v11, v5, v14
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v10, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v1, v11
; GISEL-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v10, v11
; GISEL-NEXT:    v_mul_hi_u32 v11, v17, v14
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v10, v1
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v11, v1
...
; GISEL-NEXT:    v_mul_hi_u32 v11, v15, v0
; GISEL-NEXT:    v_mul_hi_u32 v0, v16, v0
...
; GISEL-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v11, v10
; GISEL-NEXT:    v_add_i32_e32 v14, vcc, v0, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
...
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v15, v0
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v7, v14, v[10:11]
; GISEL-NEXT:    v_subb_u32_e64 v1, s[4:5], v16, v5, vcc
; GISEL-NEXT:    v_sub_i32_e64 v5, s[4:5], v16, v5
...
; GISEL-NEXT:    v_subbrev_u32_e32 v1, vcc, 0, v1, vcc
; GISEL-NEXT:    v_add_i32_e32 v15, vcc, 1, v14
...
; GISEL-NEXT:    v_add_i32_e32 v7, vcc, 1, v15
; GISEL-NEXT:    v_addc_u32_e32 v8, vcc, 0, v16, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; GISEL-NEXT:    v_mul_f32_e32 v0, 0x5f7ffffc, v1
; GISEL-NEXT:    v_mul_f32_e32 v1, 0x2f800000, v0
; GISEL-NEXT:    v_trunc_f32_e32 v1, v1
...
; GISEL-NEXT:    v_sub_i32_e64 v15, s[4:5], 0, v10
; GISEL-NEXT:    v_cvt_u32_f32_e32 v13, v1
; GISEL-NEXT:    v_subb_u32_e64 v18, s[4:5], 0, v6, s[4:5]
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v15, v12, 0
; GISEL-NEXT:    v_cndmask_b32_e32 v8, v16, v8, vcc
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v11
; GISEL-NEXT:    v_mul_lo_u32 v19, v13, v0
; GISEL-NEXT:    v_mul_hi_u32 v20, v12, v0
; GISEL-NEXT:    v_mul_hi_u32 v21, v13, v0
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v15, v13, v[1:2]
; GISEL-NEXT:    v_cndmask_b32_e32 v11, v14, v7, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v18, v12, v[0:1]
; GISEL-NEXT:    v_mul_lo_u32 v1, v12, v0
...
; GISEL-NEXT:    v_add_i32_e64 v14, s[4:5], v14, v21
...
; GISEL-NEXT:    v_add_i32_e64 v12, s[4:5], v12, v1
; GISEL-NEXT:    v_addc_u32_e64 v13, s[4:5], v13, v0, s[4:5]
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v15, v12, 0
; GISEL-NEXT:    v_cndmask_b32_e32 v14, v17, v8, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v15, v13, v[1:2]
; GISEL-NEXT:    v_xor_b32_e32 v1, v11, v9
; GISEL-NEXT:    v_ashrrev_i32_e32 v11, 31, v3
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v18, v12, v[7:8]
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v11
; GISEL-NEXT:    v_addc_u32_e32 v3, vcc, v3, v11, vcc
; GISEL-NEXT:    v_xor_b32_e32 v8, v2, v11
; GISEL-NEXT:    v_mul_lo_u32 v2, v13, v0
...
; GISEL-NEXT:    v_addc_u32_e32 v2, vcc, v13, v2, vcc
; GISEL-NEXT:    v_mul_lo_u32 v3, v15, v0
; GISEL-NEXT:    v_mul_lo_u32 v4, v8, v2
; GISEL-NEXT:    v_mul_hi_u32 v12, v8, v0
; GISEL-NEXT:    v_mul_hi_u32 v0, v15, v0
; GISEL-NEXT:    v_xor_b32_e32 v7, v14, v9
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v4
; GISEL-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v12
; GISEL-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v12, v15, v2
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v4, v3
; GISEL-NEXT:    v_mul_hi_u32 v4, v8, v2
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v12, v0
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v4
; GISEL-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
...
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v4, v0
; GISEL-NEXT:    v_mul_hi_u32 v4, v15, v2
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v10, v12, 0
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, v4, v0
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v10, v13, v[3:4]
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v1, v9
...
; GISEL-NEXT:    v_add_i32_e32 v7, vcc, 1, v12
...
; CGP-NEXT:    v_mul_hi_u32 v11, v13, v11
...
; CGP-NEXT:    v_addc_u32_e32 v13, vcc, v13, v11, vcc
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v15, v14, 0
; CGP-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v15, v13, v[11:12]
; CGP-NEXT:    v_ashrrev_i32_e32 v15, 31, v9
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v8, v15
; CGP-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v16, v14, v[11:12]
; CGP-NEXT:    v_addc_u32_e32 v9, vcc, v9, v15, vcc
; CGP-NEXT:    v_xor_b32_e32 v12, v8, v15
; CGP-NEXT:    v_mul_lo_u32 v8, v13, v10
; CGP-NEXT:    v_mul_lo_u32 v16, v14, v11
; CGP-NEXT:    v_xor_b32_e32 v17, v9, v15
...
; CGP-NEXT:    v_mul_hi_u32 v16, v14, v11
...
; CGP-NEXT:    v_addc_u32_e32 v9, vcc, v13, v9, vcc
...
; CGP-NEXT:    v_mul_hi_u32 v11, v17, v9
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v4, v13, 0
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v11, v10
...
; CGP-NEXT:    v_cndmask_b32_e64 v10, v12, v14, s[4:5]
...
; CGP-NEXT:    v_mul_lo_u32 v5, v11, v8
; CGP-NEXT:    v_mul_lo_u32 v13, v6, v9
; CGP-NEXT:    v_xor_b32_e32 v14, v7, v12
...
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v6, v5
; CGP-NEXT:    v_addc_u32_e32 v6, vcc, v11, v7, vcc
...
; CGP-NEXT:    v_mul_hi_u32 v8, v14, v6
; CGP-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v4, v9, 0
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v8, v7
...
; CGP-NEXT:    v_subb_u32_e64 v7, s[4:5], v14, v6, vcc
; CGP-NEXT:    v_sub_i32_e64 v6, s[4:5], v14, v6
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v7, v3
; CGP-NEXT:    v_subb_u32_e32 v6, vcc, v6, v3, vcc
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v5, v4
...
; CGP-NEXT:    v_sub_i32_e64 v2, s[4:5], v0, v3
...
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v9, v7, v[4:5]
; GISEL-NEXT:    v_mul_hi_u32 v12, v8, v3
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v11, v8, v[4:5]
; GISEL-NEXT:    v_mul_lo_u32 v5, v7, v3
; GISEL-NEXT:    v_mul_hi_u32 v3, v7, v3
; GISEL-NEXT:    v_mul_lo_u32 v13, v8, v4
; GISEL-NEXT:    v_mul_lo_u32 v14, v7, v4
...
; GISEL-NEXT:    v_mul_hi_u32 v0, v8, v3
; GISEL-NEXT:    v_mul_hi_u32 v3, v7, v3
...
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v9, v0
; GISEL-NEXT:    v_mul_hi_u32 v9, v8, v4
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v5, v3
; GISEL-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v3, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
...
; GISEL-NEXT:    v_add_i32_e32 v3, vcc, v4, v3
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v8, v0
; GISEL-NEXT:    v_addc_u32_e32 v3, vcc, v7, v3, vcc
...
; GISEL-NEXT:    v_rcp_iflag_f32_e32 v5, v12
...
; GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v13, v12, v[6:7]
; GISEL-NEXT:    v_cmp_ge_u32_e64 s[4:5], v9, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v15, 0, -1, s[4:5]
; GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v14, v11, v[6:7]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v10
; GISEL-NEXT:    v_cndmask_b32_e64 v10, -1, v15, s[4:5]
...
; GISEL-NEXT:    v_addc_u32_e32 v12, vcc, v12, v6, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v13, v11, 0
; GISEL-NEXT:    v_sub_i32_e32 v9, vcc, v9, v1
; GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v13, v12, v[6:7]
; GISEL-NEXT:    v_subbrev_u32_e32 v8, vcc, 0, v8, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v14, v11, v[6:7]
; GISEL-NEXT:    v_add_i32_e32 v13, vcc, 1, v0
...
; GISEL-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v8, v12, v6
; GISEL-NEXT:    v_mul_hi_u32 v5, v12, v5
...
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, 1, v13
...
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, v8, v5
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, v5, v12
; GISEL-NEXT:    v_add_i32_e32 v8, vcc, v5, v7
; GISEL-NEXT:    v_mul_hi_u32 v12, 0, v6
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v3, v8, 0
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v13, v9, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v3, v12, v[6:7]
; GISEL-NEXT:    v_cndmask_b32_e32 v9, v15, v11, vcc

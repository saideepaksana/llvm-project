...
; CHECK-NEXT:    v_sub_i32_e32 v10, vcc, 0, v0
...
; CHECK-NEXT:    v_cvt_u32_f32_e32 v9, v2
; CHECK-NEXT:    v_cvt_u32_f32_e32 v8, v3
; CHECK-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v10, v9, 0
; CHECK-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v10, v8, v[3:4]
; CHECK-NEXT:    v_mul_lo_u32 v3, v8, v2
; CHECK-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v11, v9, v[6:7]
; CHECK-NEXT:    v_mul_hi_u32 v7, v9, v2
; CHECK-NEXT:    v_mul_hi_u32 v2, v8, v2
; CHECK-NEXT:    v_mul_lo_u32 v12, v9, v6
...
; CHECK-NEXT:    v_mul_hi_u32 v7, v9, v6
...
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v9, v2
...
; CHECK-NEXT:    v_addc_u32_e32 v3, vcc, v8, v3, vcc
; CHECK-NEXT:    v_mul_lo_u32 v4, v11, v2
...
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v4, v7
; CHECK-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CHECK-NEXT:    v_mul_lo_u32 v7, v11, v3
...
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v6, v2
; CHECK-NEXT:    v_mul_hi_u32 v6, v11, v3
...
; CHECK-NEXT:    v_subb_u32_e64 v4, s[4:5], v11, v3, vcc
; CHECK-NEXT:    v_sub_i32_e64 v3, s[4:5], v11, v3
...
; CHECK-NEXT:    v_xor_b32_e32 v1, v1, v10
; CHECK-NEXT:    v_sub_i32_e32 v0, vcc, v0, v10
; CHECK-NEXT:    v_subb_u32_e32 v1, vcc, v1, v10, vcc
...
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v13, v12, v[10:11]
...
; GISEL-NEXT:    v_add_i32_e32 v15, vcc, v4, v9
; GISEL-NEXT:    v_addc_u32_e32 v12, vcc, v12, v10, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v13, v15, 0
; GISEL-NEXT:    v_ashrrev_i32_e32 v4, 31, v1
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v4
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v13, v12, v[10:11]
; GISEL-NEXT:    v_addc_u32_e32 v1, vcc, v1, v4, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v14, v15, v[10:11]
; GISEL-NEXT:    v_xor_b32_e32 v11, v0, v4
; GISEL-NEXT:    v_mul_lo_u32 v0, v12, v9
...
; GISEL-NEXT:    v_mul_lo_u32 v1, v12, v10
...
; GISEL-NEXT:    v_sub_i32_e32 v12, vcc, v10, v5
; GISEL-NEXT:    v_cndmask_b32_e64 v9, v1, v9, s[4:5]
; GISEL-NEXT:    v_subbrev_u32_e64 v13, s[4:5], 0, v0, vcc
...
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], v13, v8
; GISEL-NEXT:    v_subb_u32_e32 v8, vcc, v0, v8, vcc
...
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v18, v15, v[0:1]
...
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v19, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v1, v20
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
...
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v15, v1
; GISEL-NEXT:    v_addc_u32_e32 v13, vcc, v16, v0, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v17, v12, 0
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v9
; GISEL-NEXT:    v_cndmask_b32_e32 v5, v10, v5, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v10, v11, v8, vcc
...
; CGP-NEXT:    v_addc_u32_e32 v5, vcc, v5, v3, vcc
; CGP-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v13, v12, 0
; CGP-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v13, v5, v[3:4]
...
; CGP-NEXT:    v_mul_lo_u32 v4, v5, v2
; CGP-NEXT:    v_mul_lo_u32 v14, v12, v3
; CGP-NEXT:    v_mul_hi_u32 v2, v5, v2
...
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v15
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v15, v5, v3
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v14, v4
; CGP-NEXT:    v_mul_hi_u32 v14, v12, v3
...
; CGP-NEXT:    v_addc_u32_e32 v3, vcc, v5, v3, vcc
...
; CGP-NEXT:    v_mul_hi_u32 v5, v7, v5
...
; CGP-NEXT:    v_addc_u32_e32 v7, vcc, v7, v5, vcc
; CGP-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v11, v10, 0
; CGP-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v11, v7, v[5:6]
...
; CGP-NEXT:    v_xor_b32_e32 v9, v6, v11
; CGP-NEXT:    v_mul_lo_u32 v6, v7, v4
; CGP-NEXT:    v_mul_lo_u32 v12, v10, v5
; CGP-NEXT:    v_mul_hi_u32 v4, v7, v4
...
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v6, v13
; CGP-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v13, v7, v5
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v12, v6
; CGP-NEXT:    v_mul_hi_u32 v12, v10, v5
...
; CGP-NEXT:    v_addc_u32_e32 v5, vcc, v7, v5, vcc
...
; CGP-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v3, v10, v[5:6]
...
; CGP-NEXT:    v_sub_i32_e32 v5, vcc, v16, v4
; CGP-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], -1, v7, v[0:1]
; CGP-NEXT:    v_subbrev_u32_e32 v19, vcc, 0, v17, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v18
; CGP-NEXT:    v_cndmask_b32_e32 v1, v16, v5, vcc
; CGP-NEXT:    v_mul_lo_u32 v16, v7, v0
; CGP-NEXT:    v_cndmask_b32_e32 v5, v17, v19, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v13
; CGP-NEXT:    v_cndmask_b32_e32 v13, v14, v1, vcc
; CGP-NEXT:    v_add_i32_e64 v1, s[4:5], v9, v16
...
; CGP-NEXT:    v_cndmask_b32_e32 v9, v15, v5, vcc
; CGP-NEXT:    v_xor_b32_e32 v10, v13, v12
...
; CHECK-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v9, v8, v[6:7]
...
; CHECK-NEXT:    v_mul_lo_u32 v10, v2, v6
; CHECK-NEXT:    v_xor_b32_e32 v11, v4, v9
...
; CHECK-NEXT:    v_mul_hi_u32 v10, v2, v6
...
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v6, v4
; CHECK-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; CHECK-NEXT:    v_addc_u32_e32 v3, vcc, v8, v4, vcc
; CHECK-NEXT:    v_mul_lo_u32 v4, v11, v2
...
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v4, v6
; CHECK-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CHECK-NEXT:    v_mul_lo_u32 v6, v11, v3
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v5, v4
...
; CHECK-NEXT:    v_mul_hi_u32 v5, v11, v3
...
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v15, v4, 0
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v15, v14, v[9:10]
; GISEL-NEXT:    v_mul_lo_u32 v9, v14, v8
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v16, v4, v[12:13]
...
; GISEL-NEXT:    v_add_i32_e32 v17, vcc, v4, v8
; GISEL-NEXT:    v_addc_u32_e32 v14, vcc, v14, v9, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v15, v17, 0
; GISEL-NEXT:    v_ashrrev_i32_e32 v4, 31, v1
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v4
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v15, v14, v[9:10]
; GISEL-NEXT:    v_addc_u32_e32 v1, vcc, v1, v4, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v16, v17, v[12:13]
; GISEL-NEXT:    v_xor_b32_e32 v13, v0, v4
; GISEL-NEXT:    v_mul_lo_u32 v0, v14, v8
; GISEL-NEXT:    v_mul_lo_u32 v9, v17, v12
; GISEL-NEXT:    v_xor_b32_e32 v15, v1, v4
; GISEL-NEXT:    v_mul_hi_u32 v1, v17, v8
; GISEL-NEXT:    v_mul_hi_u32 v8, v14, v8
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v1, v14, v12
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v9, v0
; GISEL-NEXT:    v_mul_hi_u32 v9, v17, v12
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v1, v8
; GISEL-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v1, v9
; GISEL-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v8, vcc, v8, v9
; GISEL-NEXT:    v_mul_hi_u32 v9, v14, v12
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v8, v1
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v9, v1
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v17, v0
; GISEL-NEXT:    v_addc_u32_e32 v1, vcc, v14, v1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v8, v15, v0
; GISEL-NEXT:    v_mul_lo_u32 v9, v13, v1
...
; GISEL-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v9, vcc, v12, v9
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v0, v8
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
...
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v7, v12, v[8:9]
; GISEL-NEXT:    v_sub_i32_e32 v9, vcc, v13, v0
; GISEL-NEXT:    v_subb_u32_e64 v12, s[4:5], v15, v8, vcc
; GISEL-NEXT:    v_sub_i32_e64 v0, s[4:5], v15, v8
...
; GISEL-NEXT:    v_subbrev_u32_e64 v15, s[4:5], 0, v0, vcc
...
; GISEL-NEXT:    v_trunc_f32_e32 v1, v1
; GISEL-NEXT:    v_mac_f32_e32 v0, 0xcf800000, v1
; GISEL-NEXT:    v_cndmask_b32_e64 v10, v11, v16, s[4:5]
; GISEL-NEXT:    v_cvt_u32_f32_e32 v11, v0
; GISEL-NEXT:    v_sub_i32_e32 v17, vcc, 0, v6
; GISEL-NEXT:    v_cvt_u32_f32_e32 v16, v1
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v17, v11, 0
; GISEL-NEXT:    v_subb_u32_e32 v18, vcc, 0, v8, vcc
; GISEL-NEXT:    v_mul_lo_u32 v19, v16, v0
; GISEL-NEXT:    v_mul_hi_u32 v20, v11, v0
; GISEL-NEXT:    v_mul_hi_u32 v21, v16, v0
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v17, v16, v[1:2]
; GISEL-NEXT:    v_sub_i32_e32 v5, vcc, v14, v5
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v18, v11, v[0:1]
...
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v1, v20
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v14, v16, v0
; GISEL-NEXT:    v_add_i32_e32 v1, vcc, v10, v1
...
; GISEL-NEXT:    v_add_i32_e32 v10, vcc, v14, v10
; GISEL-NEXT:    v_add_i32_e32 v0, vcc, v0, v10
; GISEL-NEXT:    v_add_i32_e32 v11, vcc, v11, v1
; GISEL-NEXT:    v_addc_u32_e32 v14, vcc, v16, v0, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v17, v11, 0
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v13
...
; GISEL-NEXT:    v_xor_b32_e32 v1, v5, v4
; GISEL-NEXT:    v_ashrrev_i32_e32 v5, 31, v3
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v18, v11, v[9:10]
...
; GISEL-NEXT:    v_xor_b32_e32 v13, v3, v5
...
; GISEL-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; GISEL-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v3, v14, v9
...
; CGP-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v14, v13, v[11:12]
...
; CGP-NEXT:    v_mul_hi_u32 v16, v4, v11
; CGP-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
...
; CGP-NEXT:    v_xor_b32_e32 v16, v9, v14
...
; CGP-NEXT:    v_addc_u32_e32 v8, vcc, v13, v9, vcc
; CGP-NEXT:    v_mul_lo_u32 v9, v16, v4
; CGP-NEXT:    v_mul_lo_u32 v10, v12, v8
; CGP-NEXT:    v_mul_hi_u32 v11, v12, v4
; CGP-NEXT:    v_mul_hi_u32 v4, v16, v4
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v9, v10
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v9, v11
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v11, v16, v8
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v10, v9
...
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; CGP-NEXT:    v_mul_hi_u32 v11, v16, v8
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v10, v9
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v0, v4, 0
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v11, v10
; CGP-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v0, v10, v[9:10]
...
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v11, v4, 0
; CGP-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v11, v6, v[9:10]
; CGP-NEXT:    v_mul_hi_u32 v13, v4, v8
; CGP-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v12, v4, v[9:10]
...
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v8, v4
...
; CGP-NEXT:    v_subb_u32_e64 v6, s[4:5], v7, v5, vcc
; CGP-NEXT:    v_sub_i32_e64 v5, s[4:5], v7, v5
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v6, v3
; CGP-NEXT:    v_cndmask_b32_e64 v7, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v4, v2
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, -1, s[4:5]
...
; GISEL-NEXT:    v_mul_hi_u32 v12, v9, v3
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v11, v9, v[4:5]
...
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v11, v9, v[4:5]
; GISEL-NEXT:    v_mul_lo_u32 v5, v8, v3
; GISEL-NEXT:    v_mul_hi_u32 v11, v9, v3
...
; GISEL-NEXT:    v_mul_hi_u32 v10, v9, v4
...
; GISEL-NEXT:    v_mul_hi_u32 v8, v0, v4
; GISEL-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, v9, v5
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, v5, v8
; GISEL-NEXT:    v_add_i32_e32 v8, vcc, v5, v6
; GISEL-NEXT:    v_cvt_f32_u32_e32 v9, v3
; GISEL-NEXT:    v_mul_hi_u32 v6, 0, v4
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v1, v8, 0
; GISEL-NEXT:    v_mac_f32_e32 v9, 0x4f800000, v7
; GISEL-NEXT:    v_rcp_iflag_f32_e32 v9, v9
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v1, v6, v[5:6]
; GISEL-NEXT:    v_sub_i32_e32 v12, vcc, 0, v3
; GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], 0, v8, v[5:6]
...
; GISEL-NEXT:    v_cvt_u32_f32_e32 v11, v6
; GISEL-NEXT:    v_subb_u32_e64 v13, s[4:5], 0, 0, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v12, v10, 0
; GISEL-NEXT:    v_sub_i32_e32 v0, vcc, v0, v4
; GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v12, v11, v[6:7]
; GISEL-NEXT:    v_subb_u32_e64 v14, s[4:5], 0, v7, vcc
; GISEL-NEXT:    v_sub_i32_e64 v15, s[4:5], 0, v7
; GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v13, v10, v[8:9]
...
; GISEL-NEXT:    v_cndmask_b32_e64 v9, -1, v4, s[4:5]
...
; GISEL-NEXT:    v_add_i32_e64 v7, s[4:5], v10, v4
; GISEL-NEXT:    v_addc_u32_e64 v8, s[4:5], v11, v5, s[4:5]
; GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v7, 0
; GISEL-NEXT:    v_subbrev_u32_e32 v10, vcc, 0, v15, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v12, v8, v[5:6]
; GISEL-NEXT:    v_sub_i32_e32 v11, vcc, v0, v1
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v13, v7, v[5:6]
; GISEL-NEXT:    v_mul_lo_u32 v12, v8, v4
; GISEL-NEXT:    v_subbrev_u32_e32 v10, vcc, 0, v10, vcc
; GISEL-NEXT:    v_mul_lo_u32 v13, v7, v5
; GISEL-NEXT:    v_mul_hi_u32 v15, v7, v4
...
; GISEL-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; GISEL-NEXT:    v_mul_lo_u32 v15, v8, v5
; GISEL-NEXT:    v_mul_hi_u32 v4, v8, v4
; GISEL-NEXT:    v_add_i32_e32 v12, vcc, v13, v12
...
; GISEL-NEXT:    v_add_i32_e32 v5, vcc, v5, v12
; GISEL-NEXT:    v_add_i32_e32 v4, vcc, v7, v4
; GISEL-NEXT:    v_addc_u32_e32 v5, vcc, v8, v5, vcc
...
; GISEL-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v9
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], 0, v7, v[5:6]
; GISEL-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v14, v10, vcc

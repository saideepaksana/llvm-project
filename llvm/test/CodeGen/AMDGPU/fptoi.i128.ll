...
; GISEL-NEXT:    v_cndmask_b32_e32 v5, 0, v0, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v10, 0, v1, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[6:7], v5, v9, 0
; GISEL-NEXT:    v_cndmask_b32_e32 v3, v3, v6, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v2
; GISEL-NEXT:    v_cndmask_b32_e64 v6, v3, 0, s[6:7]
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[8:9], v10, v9, v[0:1]
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[8:9], v5, v8, 0
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[8:9], v6, v8, v[2:3]
; GISEL-NEXT:    v_mul_lo_u32 v11, v10, v9
; GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[8:9], v5, v9, v[1:2]
; GISEL-NEXT:    v_mul_lo_u32 v5, v5, v9
; GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], v10, v8, v[1:2]
; GISEL-NEXT:    v_addc_co_u32_e64 v3, s[10:11], v3, v5, s[10:11]
; GISEL-NEXT:    v_addc_co_u32_e64 v3, s[8:9], v3, v11, s[8:9]
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[8:9], v6, v9, v[3:4]
; GISEL-NEXT:    v_cndmask_b32_e32 v3, v4, v7, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v3, v3, 0, s[6:7]
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[6:7], v3, v8, v[5:6]
...
; GISEL-NEXT:    v_cndmask_b32_e32 v5, 0, v0, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v10, 0, v1, vcc
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[6:7], v5, v8, 0
; GISEL-NEXT:    v_cndmask_b32_e32 v3, v3, v6, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v2
; GISEL-NEXT:    v_cndmask_b32_e64 v6, v3, 0, s[6:7]
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[8:9], v10, v8, v[0:1]
; GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[8:9], v5, v9, 0
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[8:9], v6, v9, v[2:3]
; GISEL-NEXT:    v_mul_lo_u32 v11, v10, v8
; GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[8:9], v5, v8, v[1:2]
; GISEL-NEXT:    v_mul_lo_u32 v5, v5, v8
; GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], v10, v9, v[1:2]
; GISEL-NEXT:    v_addc_co_u32_e64 v3, s[10:11], v3, v5, s[10:11]
; GISEL-NEXT:    v_addc_co_u32_e64 v3, s[8:9], v3, v11, s[8:9]
; GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[8:9], v6, v8, v[3:4]
; GISEL-NEXT:    v_cndmask_b32_e32 v3, v4, v7, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v3, v3, 0, s[6:7]
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[6:7], v3, v9, v[5:6]
; GISEL-NEXT:    ; implicit-def: $vgpr6
; GISEL-NEXT:    ; implicit-def: $vgpr4_vgpr5
; GISEL-NEXT:    ; implicit-def: $vgpr9
; GISEL-NEXT:    ; implicit-def: $vgpr8
...
; GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[8:9], v5, v8, v[2:3]
; GISEL-NEXT:    v_mul_lo_u32 v11, v10, v9
; GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[8:9], v7, v9, v[1:2]
; GISEL-NEXT:    v_mul_lo_u32 v7, v7, v9
; GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], v10, v8, v[1:2]
; GISEL-NEXT:    v_addc_co_u32_e64 v3, s[10:11], v3, v7, s[10:11]
; GISEL-NEXT:    v_addc_co_u32_e64 v3, s[8:9], v3, v11, s[8:9]
; GISEL-NEXT:    v_mad_u64_u32 v[9:10], s[8:9], v5, v9, v[3:4]
; GISEL-NEXT:    v_cndmask_b32_e32 v3, v6, v4, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v3, v3, 0, s[6:7]
; GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[6:7], v3, v8, v[9:10]

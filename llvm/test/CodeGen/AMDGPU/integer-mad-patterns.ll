...
; GFX10-GISEL-NEXT:    v_pk_mad_u16 v5, v1, v3, v1
; GFX10-GISEL-NEXT:    v_pk_mad_u16 v0, v0, v2, 1 op_sel_hi:[1,1,0]
; GFX10-GISEL-NEXT:    v_pk_mad_u16 v1, v1, v3, 1 op_sel_hi:[1,1,0]
; GFX10-GISEL-NEXT:    v_pk_mul_lo_u16 v6, v4, v2
; GFX10-GISEL-NEXT:    v_pk_mul_lo_u16 v7, v5, v3
; GFX10-GISEL-NEXT:    v_pk_mad_u16 v2, v4, v2, 1 op_sel_hi:[1,1,0]
; GFX10-GISEL-NEXT:    v_pk_mad_u16 v3, v5, v3, 1 op_sel_hi:[1,1,0]
; GFX10-GISEL-NEXT:    v_pk_mul_lo_u16 v0, v6, v0
; GFX10-GISEL-NEXT:    v_pk_mul_lo_u16 v1, v7, v1
; GFX10-GISEL-NEXT:    v_pk_mul_lo_u16 v0, v0, v2
; GFX10-GISEL-NEXT:    v_pk_mul_lo_u16 v1, v1, v3
...
; GFX11-GISEL-NEXT:    v_pk_mad_u16 v5, v1, v3, v1
; GFX11-GISEL-NEXT:    v_pk_mad_u16 v0, v0, v2, 1 op_sel_hi:[1,1,0]
; GFX11-GISEL-NEXT:    v_pk_mad_u16 v1, v1, v3, 1 op_sel_hi:[1,1,0]
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-GISEL-NEXT:    v_pk_mul_lo_u16 v6, v4, v2
; GFX11-GISEL-NEXT:    v_pk_mul_lo_u16 v7, v5, v3
; GFX11-GISEL-NEXT:    v_pk_mad_u16 v2, v4, v2, 1 op_sel_hi:[1,1,0]
; GFX11-GISEL-NEXT:    v_pk_mad_u16 v3, v5, v3, 1 op_sel_hi:[1,1,0]
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-GISEL-NEXT:    v_pk_mul_lo_u16 v0, v6, v0
; GFX11-GISEL-NEXT:    v_pk_mul_lo_u16 v1, v7, v1
; GFX11-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
...
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v9, vcc, v6, v9, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v1, v3, v[5:6]
; GFX7-GISEL-NEXT:    v_add_i32_e32 v5, vcc, 1, v0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v9, v2, v[7:8]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v4, v5, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v0, vcc, 0, v6, vcc
; GFX7-GISEL-NEXT:    v_add_i32_e32 v6, vcc, 1, v4
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v4, v0, v[3:4]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v2, v6, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v8, vcc, 0, v7, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v7, v5, v[3:4]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v2, v8, v[1:2]
...
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v9, vcc, v6, v9, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v1, v3, v[5:6]
; GFX8-GISEL-NEXT:    v_add_u32_e32 v5, vcc, 1, v0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v9, v2, v[7:8]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v4, v5, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v0, vcc, 0, v6, vcc
; GFX8-GISEL-NEXT:    v_add_u32_e32 v6, vcc, 1, v4
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v4, v0, v[3:4]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v2, v6, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v8, vcc, 0, v7, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v7, v5, v[3:4]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v2, v8, v[1:2]
...
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v9, vcc, v6, v9, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v1, v3, v[5:6]
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v5, vcc, 1, v0
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v9, v2, v[7:8]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v4, v5, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v0, vcc, 0, v6, vcc
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v6, vcc, 1, v4
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v4, v0, v[3:4]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v2, v6, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v8, vcc, 0, v7, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v7, v5, v[3:4]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v2, v8, v[1:2]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v3, v6, v[1:2]
; GFX900-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v13, vcc, v10, v13, vcc
; GFX7-GISEL-NEXT:    v_add_i32_e32 v14, vcc, 1, v2
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v1, v5, v[9:10]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v14, v6, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v15, vcc, 0, v3, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v14, v7, v[2:3]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v13, v4, v[11:12]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v15, v6, v[2:3]
; GFX7-GISEL-NEXT:    v_add_i32_e32 v5, vcc, v1, v14
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v5, v6, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v9, vcc, v4, v15, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v5, v7, v[3:4]
; GFX7-GISEL-NEXT:    v_add_i32_e32 v7, vcc, 1, v0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v3, vcc, 0, v10, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v9, v6, v[12:13]
; GFX7-GISEL-NEXT:    v_add_i32_e32 v9, vcc, 1, v1
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v0, vcc, 0, v4, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v2, v9, 0
; GFX7-GISEL-NEXT:    v_add_i32_e32 v10, vcc, 1, v2
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v2, v0, v[5:6]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v8, v7, 0
; GFX7-GISEL-NEXT:    v_addc_u32_e32 v15, vcc, 0, v12, vcc
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v8, v3, v[6:7]
; GFX7-GISEL-NEXT:    v_add_i32_e64 v13, s[4:5], 1, v8
; GFX7-GISEL-NEXT:    v_addc_u32_e64 v14, s[4:5], 0, v11, s[4:5]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v11, v7, v[2:3]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v12, v9, v[0:1]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v5, v13, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v4, v10, 0
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v5, v14, v[1:2]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v4, v15, v[3:4]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v6, v13, v[8:9]
; GFX7-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v7, v10, v[3:4]
...
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v13, vcc, v10, v13, vcc
; GFX8-GISEL-NEXT:    v_add_u32_e32 v14, vcc, 1, v2
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v1, v5, v[9:10]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v14, v6, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v15, vcc, 0, v3, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v14, v7, v[2:3]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v13, v4, v[11:12]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v15, v6, v[2:3]
; GFX8-GISEL-NEXT:    v_add_u32_e32 v5, vcc, v1, v14
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v5, v6, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v9, vcc, v4, v15, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v5, v7, v[3:4]
; GFX8-GISEL-NEXT:    v_add_u32_e32 v7, vcc, 1, v0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v3, vcc, 0, v10, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v9, v6, v[12:13]
; GFX8-GISEL-NEXT:    v_add_u32_e32 v9, vcc, 1, v1
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v0, vcc, 0, v4, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v2, v9, 0
; GFX8-GISEL-NEXT:    v_add_u32_e32 v10, vcc, 1, v2
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v2, v0, v[5:6]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v8, v7, 0
; GFX8-GISEL-NEXT:    v_addc_u32_e32 v15, vcc, 0, v12, vcc
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v8, v3, v[6:7]
; GFX8-GISEL-NEXT:    v_add_u32_e64 v13, s[4:5], 1, v8
; GFX8-GISEL-NEXT:    v_addc_u32_e64 v14, s[4:5], 0, v11, s[4:5]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v11, v7, v[2:3]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v12, v9, v[0:1]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v5, v13, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v4, v10, 0
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v5, v14, v[1:2]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v4, v15, v[3:4]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v6, v13, v[8:9]
; GFX8-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v7, v10, v[3:4]
...
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v13, vcc, v10, v13, vcc
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v14, vcc, 1, v2
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v1, v5, v[9:10]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[1:2], s[4:5], v14, v6, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v15, vcc, 0, v3, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v14, v7, v[2:3]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v13, v4, v[11:12]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v15, v6, v[2:3]
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v5, vcc, v1, v14
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v5, v6, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v9, vcc, v4, v15, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v5, v7, v[3:4]
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v7, vcc, 1, v0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v10, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v9, v6, v[12:13]
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v9, vcc, 1, v1
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v0, vcc, 0, v4, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v2, v9, 0
; GFX900-GISEL-NEXT:    v_add_co_u32_e32 v10, vcc, 1, v2
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v2, v0, v[5:6]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v8, v7, 0
; GFX900-GISEL-NEXT:    v_addc_co_u32_e32 v15, vcc, 0, v12, vcc
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v8, v3, v[6:7]
; GFX900-GISEL-NEXT:    v_add_co_u32_e64 v13, s[4:5], 1, v8
; GFX900-GISEL-NEXT:    v_addc_co_u32_e64 v14, s[4:5], 0, v11, s[4:5]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v11, v7, v[2:3]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v12, v9, v[0:1]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v5, v13, 0
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v4, v10, 0
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v5, v14, v[1:2]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v4, v15, v[3:4]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v6, v13, v[8:9]
; GFX900-GISEL-NEXT:    v_mad_u64_u32 v[3:4], s[4:5], v7, v10, v[3:4]
...
; GFX9-NEXT:    v_pk_add_u16 v0, v0, 1 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_mad_u16 v2, v0, v1, v0
; GFX9-NEXT:    v_pk_mul_lo_u16 v2, v2, v1
; GFX9-NEXT:    v_pk_mad_u16 v0, v0, v1, 1 op_sel_hi:[1,1,0]
; GFX9-NEXT:    v_pk_mad_u16 v1, v2, v0, v0
; GFX9-NEXT:    v_pk_mul_lo_u16 v1, v1, v2
; GFX9-NEXT:    v_pk_mad_u16 v0, v2, v0, 1 op_sel_hi:[1,1,0]
; GFX9-NEXT:    v_pk_mad_u16 v2, v1, v0, v0
; GFX9-NEXT:    v_pk_mul_lo_u16 v3, v2, v1
; GFX9-NEXT:    v_pk_mad_u16 v0, v1, v0, 1 op_sel_hi:[1,1,0]
; GFX9-NEXT:    v_pk_mad_u16 v1, v2, v1, 1 op_sel_hi:[1,1,0]
; GFX9-NEXT:    v_pk_mul_lo_u16 v0, v3, v0
; GFX9-NEXT:    v_pk_mul_lo_u16 v0, v0, v1
; GFX9-NEXT:    s_setpc_b64 s[30:31]
...
; GFX10-NEXT:    v_pk_mad_u16 v2, v0, v1, v0
; GFX10-NEXT:    v_pk_mad_u16 v0, v0, v1, 1 op_sel_hi:[1,1,0]
; GFX10-NEXT:    v_pk_mul_lo_u16 v1, v2, v1
; GFX10-NEXT:    v_pk_mad_u16 v2, v1, v0, v0
; GFX10-NEXT:    v_pk_mad_u16 v0, v1, v0, 1 op_sel_hi:[1,1,0]
; GFX10-NEXT:    v_pk_mul_lo_u16 v1, v2, v1
; GFX10-NEXT:    v_pk_mad_u16 v2, v1, v0, v0
; GFX10-NEXT:    v_pk_mad_u16 v0, v1, v0, 1 op_sel_hi:[1,1,0]
; GFX10-NEXT:    v_pk_mul_lo_u16 v3, v2, v1
...
; GFX11-NEXT:    v_pk_mad_u16 v2, v0, v1, v0
; GFX11-NEXT:    v_pk_mad_u16 v0, v0, v1, 1 op_sel_hi:[1,1,0]
; GFX11-NEXT:    v_pk_mul_lo_u16 v1, v2, v1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_pk_mad_u16 v2, v1, v0, v0
; GFX11-NEXT:    v_pk_mad_u16 v0, v1, v0, 1 op_sel_hi:[1,1,0]
; GFX11-NEXT:    v_pk_mul_lo_u16 v1, v2, v1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_pk_mad_u16 v2, v1, v0, v0
; GFX11-NEXT:    v_pk_mad_u16 v0, v1, v0, 1 op_sel_hi:[1,1,0]
...
; GFX9:       ; %bb.0: ; %entry
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    v_pk_mad_u16 v2, v0, v1, v2
; GFX9-NEXT:    v_pk_mad_u16 v1, v0, v1, v3
...
; GFX10:       ; %bb.0: ; %entry
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    v_pk_mad_u16 v2, v0, v1, v2
; GFX10-NEXT:    v_pk_mad_u16 v1, v0, v1, v3
...
; GFX11:       ; %bb.0: ; %entry
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_pk_mad_u16 v2, v0, v1, v2
; GFX11-NEXT:    v_pk_mad_u16 v1, v0, v1, v3
...
; GFX9:       ; %bb.0: ; %entry
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    v_pk_mul_lo_u16 v4, v0, v1
; GFX9-NEXT:    v_pk_mad_u16 v0, v0, v1, v2
; GFX9-NEXT:    ds_write_b32 v3, v4
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10:       ; %bb.0: ; %entry
; GFX10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX10-NEXT:    v_pk_mul_lo_u16 v4, v0, v1
; GFX10-NEXT:    v_pk_mad_u16 v0, v0, v1, v2
; GFX10-NEXT:    ds_write_b32 v3, v4
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11:       ; %bb.0: ; %entry
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_pk_mul_lo_u16 v4, v0, v1
; GFX11-NEXT:    v_pk_mad_u16 v0, v0, v1, v2
